//package com.changingedu.dev.util;
//
//import android.util.Log;
//
//import com.qingqing.base.utils.UtilsLog;
//import com.qingqing.base.utils.UtilsPackage;
//
///**
...
//                wrapMsgWithStackInfo(msg, stackInfo));
//        return len;
//    }
//
//    /** 单独输出运营日志，归类于INFO */
...
//                    wrapMsgWithStackInfo(msg, stackInfo) + getStackTraceInfo(tr));
//            return len;
//        }
//        else
//            return 0;
...
//            UtilsLog.getInstance().saveLogFile(DEFAULT_TAG,
//                    wrapMsgWithStackInfo("", stackInfo), getStackTraceInfo(tr));
//            return len;
//        }
//        else
//            return 0;
